...
public class Solution4 {
	 ...
	 * 分别继续对左右两部分进行排序，递归进行到最低的块，排序之后再与其旁边的块合并，合并 之后再合并。 10 4 6 3 8 5 2 7 分为两块
	 * (10 4 6 3 ) (8 5 2 7 )再各自分为两块 （10 4） （6 3） （8 5） （2 7）最后在各自分块 （10） （4 ）
	 * （6） (3) (8) (5) (2) (7 )，再对相邻两块进行排序得： 4 10 3 6 5 8 2 7，之后对相邻两块进行合并： (4
	 * 10) (3 6) (5 8) (2 7) ，再对相邻两块合并 (3 4 6 10 ) (2 4 7 8)，再对相邻两块合并 2 3 4 4 6
	 * 7 8 10
	 * 
	 */
